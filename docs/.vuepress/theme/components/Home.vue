  ...
  <div>
    <main class="home" aria-labelledby="main-title">
      <header class="hero">
        ...
        <a-button
          :type="actionBtn.type"
          :shape="actionBtn.shape"
          :size="actionBtn.size"
          :ghost="actionBtn.ghost"
          v-if="actionBtn"
        >
          <a
            v-if="isExtlink(actionBtn.link)"
            :href="link(actionBtn.link)"
            target="_blank"
          >{{ actionBtn.text }}</a>
          <RouterLink v-else :to="link(actionBtn.link)">{{ actionBtn.text }}</RouterLink>
        </a-button>
        <a-button
          :type="preactionBtn.type"
          :shape="preactionBtn.shape"
          :size="preactionBtn.size"
          :ghost="preactionBtn.ghost"
          v-if="preactionBtn"
          class="pre-btn"
        >
          <a
            v-if="isExtlink(preactionBtn.link)"
            :href="link(preactionBtn.link)"
            target="_blank"
          >{{ preactionBtn.text }}</a>
          <RouterLink v-else :to="link(preactionBtn.link)">{{ preactionBtn.text }}</RouterLink>
        </a-button>
      </header>
